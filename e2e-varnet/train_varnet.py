...
def cli_main(args):
    ...
    # optional：load pretrain weight
    # model.varnet.load_state_dict(torch.load('./brain_leaderboard_state_dict.pt'))
    # ------------
    # trainer
    # ------------
...
def build_args():
    ...
    parser.set_defaults(
        ...
        accelerator=accelerator # missing arg for accelerator
    )
